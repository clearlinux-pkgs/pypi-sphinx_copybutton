...
Source0  : https://files.pythonhosted.org/packages/19/9b/fb86f67989742b077f46b3c979d671b8fac685a23a01c64073f4f6208d27/sphinx-copybutton-0.5.1.tar.gz
...
%prep
%setup -q -n sphinx-copybutton-0.5.1
cd %{_builddir}/sphinx-copybutton-0.5.1
pushd ..
cp -a sphinx-copybutton-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668526653
